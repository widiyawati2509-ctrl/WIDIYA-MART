  ...
  return (
    <>
      <button
        ...
        className="w-full mt-3 py-2.5 px-4 rounded-xl border border-red-200 text-[var(--danger)] hover:bg-red-50 text-xs font-sora font-semibold flex items-center justify-center gap-1.5 transition-all active:scale-95 cursor-pointer"
      >
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          <div className="card-3d bg-white rounded-3xl p-6 max-w-sm w-full shadow-2xl border border-[rgba(232,214,205,0.9)] space-y-4">
            ...
            {errorMsg && (
              <p className="text-xs text-[var(--danger)] bg-red-50 p-2 rounded-lg text-center font-medium">
                {errorMsg}
              </p>
            )}
