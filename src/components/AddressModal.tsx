...
import { addAddress, setDefaultAddress } from '@/lib/actions/addresses'
...
interface AddressModalProps {
  ...
  onAddressCreated: (addr: UserAddress) => void
  onAddressDefaultChanged: (addr: UserAddress) => void
}
  ...
  const handleSetDefault = (e: React.MouseEvent, addr: UserAddress) => {
    ...
    startTransition(async () => {
      ...
      if (res?.success) {
        ...
        onAddressDefaultChanged(updated)
