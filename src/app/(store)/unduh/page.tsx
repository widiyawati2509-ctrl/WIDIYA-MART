    ...
    <div className="w-full pb-28">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="card-3d bg-white border border-[rgba(232,214,205,0.9)] rounded-3xl p-6 text-center shadow-3d space-y-4">
          <div className="w-20 h-20 rounded-[var(--radius-xl)] bg-gradient-to-br from-[var(--accent)] to-[var(--accent-2)] flex items-center justify-center mx-auto shadow-lg p-1.5">
            <Image
              src="/logo.png"
          ...
          <div>
            ...
            <div className="flex items-center justify-center gap-2 mt-2">
              <span className="text-[var(--text-caption)] font-bold px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">
                Versi 1.0.4 (Terbaru)
              </span>
              <span className="text-[var(--text-caption)] font-bold px-2.5 py-0.5 rounded-full bg-orange-50 text-orange-700 border border-orange-200">
                Ukuran 4.7 MB
              </span>
            </div>
          </div>
        ...
        <div className="card-3d bg-white border border-[rgba(232,214,205,0.9)] rounded-2xl p-4 shadow-3d space-y-3">
          ...
          <div className="space-y-2.5 text-xs text-[var(--ink)]">
            <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-[var(--paper)]/70">
              <span className="w-5 h-5 rounded-full bg-[var(--accent)] text-white flex items-center justify-center font-bold text-[var(--text-caption)] shrink-0 mt-0.5">
                1
              </span>
              <div>
                <p className="font-bold text-[var(--text-small)]">Hapus Versi Lama Terlebih Dahulu</p>
                <p className="text-[var(--text-caption)] text-[var(--ink-soft)] mt-0.5">
            ...
            <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-[var(--paper)]/70">
              ...
              <div>
                <p className="font-bold text-[var(--text-small)]">Klik "Tetap Download" di Layar Bawah</p>
                <p className="text-[var(--text-caption)] text-[var(--ink-soft)] mt-0.5">
            ...
            <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-[var(--paper)]/70">
              ...
              <div>
                <p className="font-bold text-[var(--text-small)]">Buka dari Aplikasi "File Saya / My Files"</p>
                <p className="text-[var(--text-caption)] text-[var(--ink-soft)] mt-0.5">
            ...
            <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-[var(--paper)]/70">
              ...
              <div>
                <p className="font-bold text-[var(--text-small)]">Izinkan Sumber Tidak Dikenal</p>
                <p className="text-[var(--text-caption)] text-[var(--ink-soft)] mt-0.5">
