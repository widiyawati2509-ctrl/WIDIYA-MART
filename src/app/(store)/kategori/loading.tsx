...
export default function KategoriLoading() {
  return (
    <div className="w-full pb-32 animate-page-in">
      {/* Top Header Skeleton */}
      <div className="top-header sticky top-0 z-40 px-4 pt-3.5 pb-3 border-b border-[rgba(232,214,205,0.8)] shadow-header bg-[rgba(250,240,235,0.92)] backdrop-blur-md mb-3.5">
