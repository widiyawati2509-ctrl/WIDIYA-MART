  ...
  return (
    <div className="w-full pb-28">
      ...
      <div className="p-4 space-y-3.5">
        {/* Main Points Card */}
        <div className="card-3d bg-gradient-to-br from-[#2B1810] via-[#3D2117] to-[#1E0F0A] text-white rounded-[24px] p-5 shadow-[0_12px_28px_-4px_rgba(43,24,16,0.4)] border border-amber-500/30 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-3 relative z-10">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/20 border border-amber-500/30 text-amber-300 text-[10.5px] font-sora font-bold uppercase tracking-wider">
              <Sparkles size={12} /> Saldo Poin Belanja
            </span>
            <span className="text-[11px] text-amber-200/80 font-medium">PENGENJEK MART</span>
          </div>
          ...
          <div className="pt-3 border-t border-white/10 flex items-center justify-between text-[11px] text-white/70 relative z-10">
            <span>Rasio: 1 Poin = {formatRupiah(config?.redeem_rate ?? 100)}</span>
            <Link
              href="/"
              className="press px-3 py-1 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-white font-sora font-bold text-[11px] shadow-xs active:scale-95"
            >
        ...
        {/* How It Works Card */}
        <div className="card-3d bg-card border border-[rgba(232,214,205,0.9)] rounded-[20px] p-4 shadow-3d space-y-2.5">
          ...
          <div className="space-y-2 text-[11.5px] text-[var(--ink-soft)] leading-relaxed font-medium">
                ...
                return (
                  <div key={tx.id} className="py-2.5 flex items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="text-[10px] text-[var(--ink-soft)] mt-0.5 font-medium">
